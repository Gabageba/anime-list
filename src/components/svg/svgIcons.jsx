...
export const AnimeFilledSvg = () => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 16'>
      <g>
        <path d='M16,0l2,4h-3L13,0h-2l2,4h-3L8,0h-2l2,4h-3L3,0h-1C.9,0,0,.9,0,2V14c0,1.1,.89,2,1.99,2H18c1.1,0,2-.9,2-2V0h-4Z' />
      </g>
    </svg>
  )
}
...
export const MoreSvg = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 4 16">
      <g >
        <path d="M2,4c1.1,0,2-.9,2-2S3.1,0,2,0,0,.9,0,2s.9,2,2,2Zm0,2c-1.1,0-2,.9-2,2s.9,2,2,2,2-.9,2-2-.9-2-2-2Zm0,6c-1.1,0-2,.9-2,2s.9,2,2,2,2-.9,2-2-.9-2-2-2Z"/>
      </g>
    </svg>
  )
}
